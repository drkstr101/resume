resume {
	employers {
		waweb {
			...
			type = 'Self'
			startDate = calendar(2019, 06)
			accomplishments = ['waweb_org']
		}
		expedia {
			employer = 'Expedia Group / WAVSYS'
			type = 'Direct1099'
			startDate = calendar(2018, 11)
			endDate = calendar(2019, 06)
		...
		catalyte_surge  {
			...
			endDate = calendar(2018, 06)
			accomplishments = ['catalyte_surge']
		}
		nulabel {
			employer = 'NuLabel Technologies'
			type = 'Direct1099'
			startDate = calendar(2017, 05)
			endDate = calendar(2018, 07)
